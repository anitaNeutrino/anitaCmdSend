...
typedef enum {
  ...
  PRIORITY_PARAMSLOWBINEDGE=2,
  PRIORITY_PARAMSHIGHBINEDGE=3,
  SLOPE_OF_IMAGEPEAK_VS_HILBERTPEAK=4, 
  INTERCEPT_OF_IMAGE_PEAK_VS_HILBERT_PEAK=5, 
  BIN_TO_BIN_DIFFERENCE_THRESH_DB=6, 
  ABS_MAGNITUDE_THRESH_DBM=7, 
  THETA_ANGLE_LOW_FOR_DEMOTION=8, 
  THETA_ANGLE_HIGH_FOR_DEMOTION=9, 
  THETA_ANGLE_PRIORITY_DEMOTION=10,
  WRITE_POW_SPEC_PERIOD_SECONDS=11, 
  POSITIVE_SATURATION=12, 
  NEGATIVE_SATURATION=13
