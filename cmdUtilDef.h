...
typedef enum {
  ...
  ACQD_RATE_ENABLE_DYNAMIC_L2_MASK=9,
  ...
  ACQD_RATE_SET_DYNAMIC_L2_MASK_OVER=12, //Set over rate and phi sector
  ACQD_RATE_SET_DYNAMIC_L2_MASK_UNDER=13, //Set under rate and phi sector
  ...
  ACQD_RATE_SET_DYNAMIC_L2_MASK_OVER_WINDOW=25,
  ACQD_RATE_SET_DYNAMIC_L2_MASK_UNDER_WINDOW=26
...
typedef enum {
  ...
  PRI_ASYM_SATURATION=17,
  PRI_SLEEP_TIME_KILL_X=18,
  PRI_DISABLE_GPU=19,
  PRI_CALIB_VERSION=20,
  PRI_INVERT_TOP_RING_SOFTWARE=21,
  PRI_DEBUG_MODE=22,
  PRI_SKIP_BLAST_RATIO_HPOL=23,
  PRI_SKIP_BLAST_RATIO_VPOL=24,
  PRI_BLAST_RATIO_MAX=25,
  PRI_BLAST_RATIO_MIN=26,
  PRI_BLAST_GRADIENT=27,
  PRI_STATIC_NOTCH_LOW_EDGE=28,
  PRI_STATIC_NOTCH_HIGH_EDGE=29,
  PRI_USE_LONG_DYNAMIC_FILTERING=30,
  PRI_START_DYNAMIC_FREQUENCY=31,
  PRI_STOP_DYNAMIC_FREQUENCY=32,
  PRI_CONSERVATIVE_START=33,
  PRI_THRESH_DB=34,
  PRI_DELTA_PHI_TRIG=35
...
typedef enum
{
  ...
  RTL_SET_GRACEFUL_TIMEOUT = 6,
  RTL_SET_FAIL_TIMEOUT = 7,
  RTL_SET_MAX_FAIL = 8,
  RTL_SET_DISABLED = 9
...
typedef enum
{
  ...
  TUFF_ADJUST_ACCORDING_TO_HEADING = 7,
  TUFF_DEGREES_FROM_NORTH_TO_NOTCH=8,
  TUFF_SLOPE_THRESHOLD_TO_NOTCH_NEXT_SECTOR=9,
  TUFF_PHI_SECTOR_OFFSET_FROM_NORTH=10,
  TUFF_MAX_HEADING_AGE=11, 
  TUFF_SET_CAPS_ON_STARTUP=12, 
  TUFF_SET_CAP_VALUE=13
